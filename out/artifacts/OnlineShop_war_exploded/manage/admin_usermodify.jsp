...
<%@ include file="admin_menu.jsp" %>
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            ...
            </i><a href="/OnlineShop/manage/admin_index.jsp">首页</a>
            <span class="crumb-step">&gt;</span>
            <a class="crumb-name" href="/OnlineShop/manage/admin_findUser">用户管理</a>
            <span class="crumb-step">&gt;</span><span>修改用户</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="/OnlineShop/manage/admin_doUserUpdate" method="post" id="myform" name="myform">
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="userID" size="50" value="${user.USER_ID }" type="text" readonly>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                	...
                                	<input type="radio" name="sex" value="W" ${user.USER_SEX=='W'?"checked":"" }>女
                                </td>
                            </tr>
